...
const TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '- `triggerType` — z. B. `ContaminatedTrigger_Static`.',
      '- `position` — `[x, y, z]` Weltkoordinaten.',
      '- `radius`, `positiveHeight`, `negativeHeight` — Zylindergeometrie.',
      '- `innerRingCount`, `outerRingCount`, `outerOffset` — visuelle Partikelringe.',
      '- `effects` mit Sub-Effekten (`PPE`, `Particle`, `Sound`, `Damage`).',
      '',
