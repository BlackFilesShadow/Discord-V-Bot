...
// Manager-panel lifecycle lives exclusively in virtualAccountManagerPanelSafety.ts
// (configureVirtualManagerPanelSafe / disableVirtualManagerPanelSafe /
// refreshConfiguredVirtualManagerPanelSafe / getVirtualManagerPanelSafe). An earlier,
// unsafe duplicate implementation used to live here; it was deleted after a review found
// it silently swallowed Discord permission-restore failures before deleting the only
// recovery record needed to undo bot-granted channel access.
