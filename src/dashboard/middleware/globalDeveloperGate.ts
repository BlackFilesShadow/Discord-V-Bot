 ...
 * die aktuelle DB-Rolle. Ein Rollenentzug oder eine geaenderte Owner-ID wird
 * dadurch sofort wirksam. Veraltete aktive DevSessions werden bei Ablehnung
 * best-effort widerrufen.
 */
