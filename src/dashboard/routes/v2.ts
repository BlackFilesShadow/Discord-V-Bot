...
import { nitradoTasksRouter } from './v2/nitradoTasks';
...
v2Router.use('/guilds/:guildId/nitrado-drift', nitradoDriftRouter);
v2Router.use('/guilds/:guildId/nitrado-tasks', nitradoTasksRouter);
