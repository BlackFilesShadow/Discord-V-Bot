...
import { Lock, LayoutDashboard, TerminalSquare } from 'lucide-react';
...
export default function BotAdminPage() {
  ...
  const [view, setView] = useState<'admin' | 'commands'>('admin');
  ...
  return (
    <Shell title="Bot-Admin" back="/servers">
      <div className="max-w-content mx-auto space-y-4">
        ...
        {view === 'admin' ? <BotAdminTab /> : <BotAdminCommandCenter />}
      </div>
    </Shell>
  );
}
