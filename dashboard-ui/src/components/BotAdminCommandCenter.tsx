...
function Triggers({ center, guildId }: { center: string; guildId: string }) {
  ...
  const save = useMutation({ mutationFn: async () => {
    const common = { guildId, id, triggerType, pattern, responseMode, response, channelId: channelId || undefined, cooldownSeconds: Number(cooldown), mediaUrl: mediaUrl || undefined };
    ...
    return api.post(`${center}/triggers`, common);
