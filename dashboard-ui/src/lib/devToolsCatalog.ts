...
export const DEV_TOOLS: ReadonlyArray<DevTool> = [
  ...
  { slug: 'ai-context-debugger', label: 'AI Kontext-Debugger',    icon: Brain,           status: 'ready', category: 'observability', desc: 'Hybrid-Retrieval Score-Aufschluesselung pro Wissens-Snippet.', keywords: ['ai', 'retrieval', 'rag', 'kontext', 'embedding', 'debug'] },
