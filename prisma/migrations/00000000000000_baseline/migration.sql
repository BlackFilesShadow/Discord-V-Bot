...
-- CreateEnum
CREATE TYPE "AuditCategory" AS ENUM ('AUTH', 'REGISTRATION', 'UPLOAD', 'DOWNLOAD', 'MODERATION', 'GIVEAWAY', 'LEVEL', 'ROLE', 'POLL', 'SECURITY', 'ADMIN', 'SYSTEM', 'CONFIG', 'GDPR', 'AI', 'FEED', 'TRANSLATE', 'APPEAL', 'TICKET', 'NITRADO', 'ECONOMY', 'CASINO', 'DASHBOARD', 'WHITELIST', 'FACTION', 'SERVER_SETTINGS', 'EMBED', 'KILLFEED', 'WELCOME');
...
-- CreateEnum
CREATE TYPE "FeedType" AS ENUM ('RSS', 'TWITCH', 'TWITTER', 'STEAM', 'NEWS', 'YOUTUBE', 'WEBHOOK', 'CUSTOM');
...
CREATE TABLE "SelfRoleMenu" (
    ...
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "embedId" TEXT,
    "componentType" TEXT NOT NULL DEFAULT 'BUTTON',
    "assignMode" TEXT NOT NULL DEFAULT 'TOGGLE',
...
CREATE TABLE "DashboardEmbed" (
    ...
    CONSTRAINT "DashboardEmbed_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BotAdminSession" (
    ...
    CONSTRAINT "BotAdminSession_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "IdempotencyKey" (
    "hash" TEXT NOT NULL,
    "status" "IdempotencyStatus" NOT NULL DEFAULT 'DONE',
    "responseBody" JSONB,
...
-- CreateIndex
CREATE INDEX "AutoModFilter_guildId_idx" ON "AutoModFilter"("guildId");
...
-- CreateIndex
CREATE INDEX "Feed_guildId_idx" ON "Feed"("guildId");
...
-- CreateIndex
CREATE INDEX "SelfRoleMenu_guildId_archived_idx" ON "SelfRoleMenu"("guildId", "archived");

-- CreateIndex
CREATE INDEX "SelfRoleMenu_embedId_idx" ON "SelfRoleMenu"("embedId");
...
-- CreateIndex
CREATE INDEX "Faction_guildId_nitradoConnId_idx" ON "Faction"("guildId", "nitradoConnId");

-- CreateIndex
CREATE UNIQUE INDEX "Faction_guildId_name_key" ON "Faction"("guildId", "name");

-- CreateIndex
CREATE UNIQUE INDEX "FactionSystemConfig_guildId_key" ON "FactionSystemConfig"("guildId");
...
-- CreateIndex
CREATE INDEX "BotAdminSession_userDiscordId_idx" ON "BotAdminSession"("userDiscordId");

-- CreateIndex
CREATE INDEX "BotAdminSession_expiresAt_idx" ON "BotAdminSession"("expiresAt");
...
-- AddForeignKey
ALTER TABLE "SelfRoleMenu" ADD CONSTRAINT "SelfRoleMenu_embedId_fkey" FOREIGN KEY ("embedId") REFERENCES "DashboardEmbed"("id") ON DELETE SET NULL ON UPDATE CASCADE;
