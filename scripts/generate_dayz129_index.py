...
indexed, so later upstream files cannot silently enter V-Bot's 1.29 corpus.
"""
...
def write_ts(index: dict, output: Path) -> None:
    ...
    output.write_text(
        ...
        "// Source: supplied three DayZ 1.29 ZIPs, byte-verified against Bohemia DZ_129.\n"
...
def main() -> None:
    ...
    ap.add_argument("--source", required=True, type=Path, help="Bohemia DayZ-Central-Economy DZ_129 checkout")
